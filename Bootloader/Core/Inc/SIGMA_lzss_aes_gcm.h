/**
 * @file    SIGMA_lzss_aes_gcm.h
 * @brief   LZSS decompression + AES-256-GCM decryption for STM32 bootloader.
 * @author  SAID ARNOUZ
 * @date    2025
 */

#ifndef INC_SIGMA_LZSS_AES_GCM_H_
#define INC_SIGMA_LZSS_AES_GCM_H_
...
/* Key dyal algo AES-256 khassse ykon the same li darti f Host */
...
#endif /* INC_SIGMA_LZSS_AES_GCM_H_ */
