...
#define MAX_COMP_SIZE   0xC000U    // 48KB  — compressed input
#define MAX_APP_SIZE    0x10000U   // 64KB  — decompressed output
/* ================= MAGIC ================= */
#define BOOT_MAGIC_ADDR     0x2001FFF0U
